...
/// as its error type. To handle errors from CometChatKingfisher, you switch over the error to get a reason catalog,
/// then switch over the reason to know error detail.
public enum CometChatKingfisherError: Error {
    ...
    /// Represents the error reason during CometChatKingfisher caching system.
    ///
    ...
    public enum CacheErrorReason {
        ...
        case cannotSerializeImage(image: CFCrossPlatformImage?, original: Data?, serializer: CacheSerializer)
        ...
        /// - key: The cache key used for the cache. When caching a file through `CometChatKingfisherManager` and CometChatKingfisher's
    ...
    public enum ImageSettingErrorReason {
        ...
        /// `.alternativeSources` are used and CometChatKingfisher tried to recovery from the original error, but still
...
extension CometChatKingfisherError: LocalizedError {
...
extension CometChatKingfisherError: CustomNSError {

    /// The error domain of `CometChatKingfisherError`. All errors from CometChatKingfisher is under this domain.
    public static let domain = "com.onevcat.CometChatKingfisher.Error"
...
extension CometChatKingfisherError.RequestErrorReason {
...
extension CometChatKingfisherError.ResponseErrorReason {
    var errorDescription: String? {
        switch self {
...
extension CometChatKingfisherError.CacheErrorReason {
    var errorDescription: String? {
        switch self {
...
extension CometChatKingfisherError.ProcessorErrorReason {
    var errorDescription: String? {
        switch self {
...
extension CometChatKingfisherError.ImageSettingErrorReason {
    var errorDescription: String? {
        switch self {
        case .emptySource:
