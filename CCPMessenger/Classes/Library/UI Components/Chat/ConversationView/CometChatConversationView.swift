...
class CometChatConversationView: UITableViewCell {
        ...
        didSet {
            if let currentConversation = conversation {
                ...
                case .user:
                    ...
                    let _ = status.set(status: user.status)
                case .group:
                ...
                case .message:
                    ...
                    case .image where currentConversation.conversationType == .user:
                        message.text = NSLocalizedString("HAS_SENT_AN_IMAGE", tableName: nil, bundle: CCPType.bundle, value: "", comment: "")
                    ...
                    case .custom where currentConversation.conversationType == .user:
                        message.text = NSLocalizedString("HAS_SENT_A_CUSTOM_MESSAGE", tableName: nil, bundle: CCPType.bundle, value: "", comment: "")
                    case .custom where currentConversation.conversationType == .group:
                        message.text = senderName! + ":  " + NSLocalizedString("HAS_SENT_A_CUSTOM_MESSAGE", tableName: nil, bundle: CCPType.bundle, value: "", comment: "")
                ...
                case .call:
                    message.text = NSLocalizedString("HAS_SENT_A_CALL", tableName: nil, bundle: CCPType.bundle, value: "", comment: "")
                case .custom:
                    message.text = NSLocalizedString("HAS_SENT_A_CUSTOM_MESSAGE", tableName: nil, bundle: CCPType.bundle, value: "", comment: "")
                @unknown default:
                    break
                ...
                let _ = unreadBadgeCount.set(count: currentConversation.unreadMessageCount)
            }
        }
    }
    ...
    override func awakeFromNib() {
        print("conversationview awake from nib")
        super.awakeFromNib()
    }
