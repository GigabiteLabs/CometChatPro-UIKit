...
extension CFCrossPlatformImage: Placeholder {
    /// How the placeholder should be added to a given image view.
    public func add(to imageView: CFCrossPlatformImageView) { imageView.image = self }

    /// How the placeholder should be removed from a given image view.
    public func remove(from imageView: CFCrossPlatformImageView) { imageView.image = nil }
}
...
extension Placeholder where Self: CFCrossPlatformView {
    ...
    /// How the placeholder should be added to a given image view.
    public func add(to imageView: CFCrossPlatformImageView) {
    ...
    /// How the placeholder should be removed from a given image view.
    public func remove(from imageView: CFCrossPlatformImageView) {
        removeFromSuperview()
    }
}
