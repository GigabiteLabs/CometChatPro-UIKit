...
extension CacheSerializer {
    public func image(with data: Data, options: CometChatKingfisherOptionsInfo?) -> CFCrossPlatformImage? {
...
public struct DefaultCacheSerializer: CacheSerializer {
    ...
    public func data(with image: CFCrossPlatformImage, original: Data?) -> Data? {
    ...
    /// - Returns: An image deserialized or `nil` when no valid image
    ///            could be deserialized.
    public func image(with data: Data, options: CometChatKingfisherParsedOptionsInfo) -> CFCrossPlatformImage? {
